    ...
    new Promise (resolve) ->
      ...
      if (line.endsWith(" do"))
        ...
        suggestions = [
          ...
          {
            snippet: 'getTurnOrder()'
            displayText: 'getTurnOrder()'
            type: 'function'
            leftLabel: 'table'
            description: 'Returns the current turn order.'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/turns/#functions'
          },
        ]
        ...
        suggestions = [
          {
            snippet: 'collect(${1:table|expected_ids}, ${2:function|on_finished}, ${3:function|on_add}, ${4:function|on_error})'
            displayText: 'collect(table expected_ids, function on_finished, function on_add, function on_error)'
            type: 'function'
            leftLabel: 'table'
            description: 'Creates a collect_table that can be used to track the progress across a specific task for multiple entities.'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/wait/#collect'
          },
          {
      ...
      # PlayerInstance
        ...
        suggestions = [
          ...
          {
            snippet: 'drawHandStash()'
            displayText: 'drawHandStash()'
            type: 'function'
            leftLabel: 'bool'
            description: 'Draws all cards in players hand stash into their hand'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/player/instance/#drawhandstash'
          },
          {
          ...
          {
            snippet: 'setHandStashLocation(${1:Vector|position}, ${2:int|rotation_index})'
            displayText: 'setHandStashLocation(Vector position, int rotation_index)'
            type: 'function'
            leftLabel: 'bool'
            description: 'Sets the location of the player\'s hand stash within their primary hand zone'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/player/instance/#sethandstashlocation'
          },
          {
      ...
      # Object
        ...
        suggestions = suggestions.concat [
          ...
          {
            snippet: 'deal(${1:int|number}, ${2:string|player_color}, ${3:int|hand_index}, ${4:bool|from_bottom})'
            displayText: 'deal(int number, string player_color, int hand_index, bool from_bottom)'
            type: 'function'
            leftLabel: 'bool'
          ...
          {
            snippet: 'moveToHandStash()'
            displayText: 'moveToHandStash()'
            type: 'function'
            leftLabel: 'bool'
            description: 'Moves card in hand into the player\'s hand stash'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/object/#movetohandstash'
          },
          {
            snippet: 'playLoopingEffect(${1:int|index})'
            displayText: 'playLoopingEffect(int index)'
          ...
          {
            snippet: 'putObject(${1:Object|object}, ${2:int|index})'
            displayText: 'putObject(Object object, int index)'
            type: 'function'
            leftLabel: 'Object'
        ...
        if not global_script
          suggestions = suggestions.concat [
            ...
            },
            {
              ...
              descriptionMoreURL: 'https://api.tabletopsimulator.com/events/#onstatechange'
            },
            {
              snippet: 'tryStateChange(new_state_index, player_color)\n\t${0: -- body...}\nend'
              displayText: 'tryStateChange(int new_state_index, string player_color)'
              type: 'function'
              leftLabel: 'bool'
              description: 'Called when this object is about to change state; return false to prevent the change.'
              descriptionMoreURL: 'https://api.tabletopsimulator.com/events/#trystatechange'
            },
          ]
        suggestions = suggestions.concat [
          {
          ...
          },
          {
            ...
            descriptionMoreURL: 'https://api.tabletopsimulator.com/events/#onobjectstatechange'
          },
          {
            snippet: 'tryObjectStateChange(object, new_state_index, player_color)\n\t${0: -- body...}\nend'
            displayText: 'tryObjectStateChange(Object object, int new_state_index, string player_color)'
            type: 'function'
            leftLabel: 'bool'
            description: 'Called when an object is about to change state; return false to prevent the change'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/events/#tryobjectstatechange'
          },
          {
          ...
          {
            snippet: 'onPlayerHandChoice(player_color, label, objects, was_confirmed)\n\t${0: -- body...}\nend'
            displayText: 'onPlayerHandChoice(string player_color, string label, table objects, bool was_confirmed)'
            type: 'function'
            leftLabel: 'bool'
            description: 'Automatically called when a player makes a choice in hand selection mode.'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/events/#onplayerhandchoice'
          },
          {
      ...
      # Section: Globally accessible constants & functions
        ...
        suggestions = [
          ...
          {
            snippet: 'allowRewindStore()'
            displayText: 'allowRewindStore()'
            type: 'function'
            leftLabel: 'bool'
            description: 'Clears the block on storing rewind states.'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/base/#allowrewindstore'
          },
          {
          ...
          {
            snippet: 'chooseInHand(${1:string|label}, ${2:int|min_selection_count}, ${3:int|max_selection_count}, ${4:string|prompt}, ${5:table|player_colors})'
            displayText: 'chooseInHand(string label, int min_selection_count, int max_selection_count, string prompt, table player_colors)'
            type: 'function'
            leftLabel: 'table'
            description: 'Starts or queues a hand selection mode'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/base/#chooseinhand'
          },
          {
            snippet: 'chooseInHandOrCancel(${1:string|label}, ${2:int|min_selection_count}, ${3:int|max_selection_count}, ${4:string|prompt}, ${5:table|player_colors})'
            displayText: 'chooseInHandOrCancel(string label, int min_selection_count, int max_selection_count, string prompt, table player_colors)'
            type: 'function'
            leftLabel: 'table'
            description: 'Starts or queues a hand selection mode with additional Cancel button'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/base/#chooseinhandorcancel'
          },
          {
            snippet: 'clearChooseInHand(${1:table|player_colors})'
            displayText: 'clearChooseInHand(table player_colors)'
            type: 'function'
            leftLabel: 'table'
            description: 'Clears the current hand selection mode'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/base/#clearchooseinhand'
          },
          {
            snippet: 'clearContextMenu()'
            displayText: 'clearContextMenu()'
          ...
          {
            snippet: 'currentChooseInHand(${1:string|player_color})'
            displayText: 'currentChooseInHand(string player_color)'
            type: 'function'
            leftLabel: 'string'
            description: 'Returns the label of the current hand selection mode'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/base/#currentchooseinhand'
          },
          {
          ...
          {
            snippet: 'storeRewindState(${1:function|and_then}, ${2:bool|block_further_stores})'
            displayText: 'storeRewindState(function and_then, bool block_further_stores)'
            type: 'function'
            leftLabel: 'bool'
            description: 'Stores a rewind state and optionally blocks any further rewind states being created.'
            descriptionMoreURL: 'https://api.tabletopsimulator.com/base/#storerewindstate'
          },
          {
